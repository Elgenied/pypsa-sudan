...
<article><h2>Explore the visual notebooks</h2><p><a href="notebooks/01_explore_sudan.html"><b>Regional pie maps, donuts and dispatch — 2024 illustration</b></a><br><a href="notebooks/02_reference_2022.html"><b>2022 national reference — capacity, supply and dispatch</b></a></p><p>These previews show executed notebook outputs. For editable Python cells, open <a href="notebooks/01_explore_sudan.ipynb">the regional notebook</a> or <a href="notebooks/02_reference_2022.ipynb">the 2022 notebook</a> in Jupyter with the Python (pypsa) kernel. The regional data remain a separate 2024 example.</p></article>
